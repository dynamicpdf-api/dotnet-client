...
namespace DynamicPDF.Api
{
    ...
    public class HtmlInput : ConverterInput
    {
        ...
        public HtmlInput(HtmlResource resource, string basepath = null, api.PageSize? size = null, api.PageOrientation? orientation = null, float? margins = null) : base(resource, size, orientation, margins)
        {
            if (basepath != null)
            {
                BasePath = basepath;
