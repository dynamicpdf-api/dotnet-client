...
namespace DynamicPDF.Api.Elements
{
    ...
    public class Code11BarcodeElement : TextBarcodeElement
    {
        ...
        /// <param name="xOffset">The X coordinate of the barcode.</param>
        /// <param name="yOffset">The Y coordinate of the barcode.</param>
        public Code11BarcodeElement(string value, float height, ElementPlacement placement = ElementPlacement.TopLeft, float xOffset = 0, float yOffset = 0) : base(value, placement, xOffset, yOffset) { Height = height; }
